...
public class MyOdometryOpmode extends LinearOpMode {
    ...
    String verticalLeftEncoderName = rfName, verticalRightEncoderName = lfName, horizontalEncoderName = rfName;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        goToPosition(0*COUNTS_PER_INCH, 24* COUNTS_PER_INCH, 1, 0, 1*COUNTS_PER_INCH);
